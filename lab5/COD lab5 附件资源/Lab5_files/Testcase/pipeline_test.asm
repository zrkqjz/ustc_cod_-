...
# �ϰ���Կ��� led[1] ���𣬴�ʱ����ִ���쳣
# ���ļ��� x25[5] ָʾ��ǰ���еĲ��Խ׶�
# x25 Ϊ 0x10 ���� part 1 simple test
# x25 Ϊ 0x20 ���� part 2 data test
# ��ʱ x1 �� x16 �� ��һ������ x[i] != i �� i �ǵ�һ��δͨ���Ĳ���
# x25 Ϊ 0x3X ���� part 3 control test
# x25 Ϊ 0x4X ���� part 4 hazard test
# ��ʱ x25 �ĺ���λָʾ��һ��δͨ���Ĳ���
# x25 Ϊ 0x40 ���� final test
# ���������к� x26 ��ֵΪ 1������ȫ������ͨ��
# �ϰ���Կ��� led[0] ���𣬴�ʱ����ִ������
