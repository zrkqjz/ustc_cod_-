...
module Check_Data_SEL (
    ...
    input [31:0]                dm_dout,
    input                       dm_we,
    input [31:0]                branch_cnt,
    input [31:0]                btb_succ_cnt,
    input [31:0]                btb_fail_cnt,
    ...
    always @(*) begin
        ...
        case (check_addr)
            ...
            5'd29: check_data = branch_cnt;
            5'd30: check_data = btb_succ_cnt;
            5'd31: check_data = btb_fail_cnt;
